...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    DBConnection con = new DBConnection();
      ...
      out.write("                                <center><h1 style=\"font-family: Century; font-size: 50px; color: #3EB489; margin-top: 20px;\">Login</h1><br>\n");
      out.write("\n");
      out.write("                                    <div class=\"panel-body\">\n");
      out.write("                                        <form id=\"loginForm\" role=\"form\" action=\"login-code.jsp\" method=\"post\" onsubmit=\"validateLoginForm(event)\">\n");
      out.write("                                            <div class=\"form-group input-icon\">\n");
      out.write("                                                <i class=\"fa fa-envelope\" style=\"margin-right:500px;\"></i>\n");
      out.write("                                                <input class=\"form-control\"  type=\"text\" name=\"usname\" placeholder=\"Enter your Email Id\" />\n");
      out.write("                                            </div>\n");
      out.write("                                            <div class=\"form-group input-icon\">\n");
      out.write("                                                <i class=\"fa fa-lock\" style=\"margin-right:500px;\"></i>\n");
      out.write("                                                <input class=\"form-control\" type=\"text\" name=\"password\" placeholder=\"Enter your Password\"/>\n");
      out.write("                                            </div>\n");
      out.write("                                            <button type=\"submit\" name=\"sub\" id=\"form-submit\" class=\"filled-button btn btn-primary\"  style=\"background-color:#3EB489;border:0px solid 00FF9C;\">Login</button>\n");
      out.write("                                            <br><br>\n");
      out.write("\n");
      ...
      out.write("                    Designed By <b style=\"color: white\">Aksha Diwan</b>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      ...
      out.write("                <script>\n");
      out.write("                                            function validateLoginForm(event) {\n");
      out.write("                                                event.preventDefault(); // Prevent form submission\n");
      out.write("\n");
      out.write("                                                var email = document.getElementsByName(\"usname\")[0].value;\n");
      out.write("                                                var password = document.getElementsByName(\"password\")[0].value;\n");
      out.write("                                                // Check if email or password is empty\n");
      out.write("                                                if (email.trim() === \"\" || password.trim() === \"\") {\n");
      out.write("                                                    alert(\"Please enter both email and password!\");\n");
      out.write("                                                    return false;\n");
      out.write("                                                }\n");
      out.write("\n");
      out.write("                                                if (email !== \"demo@example.com\" || password !== \"password123\") {\n");
      out.write("                                                    alert(\"Incorrect email or password! Please try again.\");\n");
      out.write("                                                    return false;\n");
      out.write("                                                }\n");
      out.write("\n");
