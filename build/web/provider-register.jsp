                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="contact-wrap w-100 p-md-5 p-4 main">
                            ...
                            <form action="provider-register-code.jsp" id="register" method="post">
                                <div class="form-group input-icon">
                                    <i class="fa fa-user"></i>
                                    <input class="form-control" type="text" name="pname" placeholder="Enter your Name" />
                                </div>

                                <div class="form-group input-icon">
                                    <i class="fa fa-info-circle"></i>
                                    <input class="form-control" type="text" name="about" placeholder="About" style="min-height:100px;"/>
                                </div>
                                ...
                                <div class="form-group input-icon">
                                    ...
                                    <input class="form-control" type="text" name="location" placeholder="Location" style="min-height:100px;"/>
                                </div>
                                ...
                                <div class="form-group input-icon">
                                    ...
                                    <input class="form-control" type="file" name="img" placeholder="Upload Image" />
                                </div>

                                <div class="form-group input-icon">
                                    <i class="fa fa-cogs"></i>
                                    <input class="form-control" type="textarea" name="amenities" placeholder="Amenities" style="min-height:100px;"/>
                                </div>
                                <div class="form-group input-icon">
